...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    testCustomAuthenAuthUserSubject.add(
      TestCustomAuthenAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<TestCustomAuthenAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  TestCustomAuthenAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = TestCustomAuthenAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    testCustomAuthenAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
TestCustomAuthenAuthUser? currentUser;
